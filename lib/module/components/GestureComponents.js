...
import { Platform, ScrollView as RNScrollView, Switch as RNSwitch, TextInput as RNTextInput, DrawerLayoutAndroid as RNDrawerLayoutAndroid, FlatList as RNFlatList, RefreshControl as RNRefreshControl } from 'react-native';
...
export const RefreshControl = Platform.OS === 'android' ? createNativeWrapper(RNRefreshControl, {
  disallowInterruption: true,
  shouldCancelWhenOutside: false
}) : RNRefreshControl; // eslint-disable-next-line @typescript-eslint/no-redeclare
