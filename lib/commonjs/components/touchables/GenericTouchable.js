...
const AnimatedBaseButton = _reactNative.Animated.createAnimatedComponent(_GestureButtons.BaseButton);
...
class GenericTouchable extends _react.Component {
  ...
  onHandlerStateChange = ({
    ...
    state === (_reactNative.Platform.OS !== 'android' ? _State.State.ACTIVE : _State.State.BEGAN) && this.STATE === TOUCHABLE_STATE.UNDETERMINED) {
      ...
      const shouldCallOnPress = !this.longPressDetected && this.STATE !== TOUCHABLE_STATE.MOVED_OUTSIDE && this.pressOutTimeout === undefined;
