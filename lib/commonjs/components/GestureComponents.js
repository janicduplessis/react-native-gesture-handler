...
exports.FlatList = exports.DrawerLayoutAndroid = exports.TextInput = exports.Switch = exports.RefreshControl = exports.ScrollView = void 0;
...
const RefreshControl = _reactNative.Platform.OS === 'android' ? (0, _createNativeWrapper.default)(_reactNative.RefreshControl, {
  disallowInterruption: true,
  shouldCancelWhenOutside: false
}) : _reactNative.RefreshControl; // eslint-disable-next-line @typescript-eslint/no-redeclare
