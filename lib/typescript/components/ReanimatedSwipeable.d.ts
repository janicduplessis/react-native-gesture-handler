...
export interface SwipeableProps extends Pick<PanGestureHandlerProps, SwipeableExcludes> {
     ...
     */
    onSwipeableOpen?: (direction: SwipeDirection.LEFT | SwipeDirection.RIGHT, swipeable: SwipeableMethods) => void;
    /**
     * Called when action panel is closed.
     */
    onSwipeableClose?: (direction: SwipeDirection.LEFT | SwipeDirection.RIGHT, swipeable: SwipeableMethods) => void;
    /**
